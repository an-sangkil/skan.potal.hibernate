...
<!--
	...
	* CreateUser : ahn
	* Document   : 주소록 그룹관리 메니지먼트 (그룹과 유저도 화면에 같이 보여짐)
	*
-->
			...
			Ext.onReady(function(){
				...
				var tree = new Tree.TreePanel({
					...
					loader: new Tree.TreeLoader({	// ajax를 위한 url을 지정합니다.
								dataUrl:'/system/code/addressGroupManagementTreeNodes/getAddressGroupCodeList.system?',//(/system/code/{viewPage}/getAddressGroupCodeList.system)
				...
				function choiceInformation(node){
					if(tree.getSelectionModel().isSelected(node)){//선택한 Node와 내가 가지고 있는 Node가 같은건지 ,
						...
						*/						
						...
						//var url = "/system/code/getCodeDetailAJU.dongbu?";
						//var evalScript = false;
						var url = "/content/address/getAddressGroupDetailAJR.dongbu?";
						var method = "GET";
