/*
 * $Id: AddressGroup.java ,v 1.1 2011. 4. 7. 오후 4:30:20 dongbuFarm Exp $
 ...
 *
 */
public class AddressGroup extends CommonElementAbst {
	...
	private String code;			//부서코드명 5자리 ex:P0001
	private String code_name;		//부서코드 한글명
	private String code_comment;	//부서코드설명
