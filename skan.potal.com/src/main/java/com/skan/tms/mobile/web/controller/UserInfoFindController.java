 ...
 */
@Controller
@RequestMapping("/userinfofind")
public class UserInfoFindController extends AbstractCommonController {
	
	private static final Logger logger = LoggerFactory.getLogger(UserInfoFindController.class);
	 ...
	 * @return
	 */
	@RequestMapping("/userIdPasswordfindForm")
	public String userIdPasswordfindForm (HttpServletRequest request, ModelMap modelMap) {

		
		return "admin/user/userIdPasswordfindForm"; 
	}
