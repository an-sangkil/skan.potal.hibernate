...
<input type="hidden" id="code" 		name="code" 	 value="${cmtbCode.cmtbCodeId.code}">
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" id="upperCode" name="upperCode" placeholder="상위코드" value="${cmtbCode.upperCode}">
			<div class="has-error">
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="tel" class="form-control" id="codeName" name="codeName" placeholder="코드명" value="${cmtbCode.codeName}">
			<div class="has-error">
